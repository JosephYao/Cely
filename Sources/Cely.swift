...
public struct Cely {
    ...
    public static func setup<T: CelyUser, U: CelyUser>(with window: UIWindow?, forModel: T, requiredProperties:[U] = [], withOptions options: [CelyOptions : Any?]? = [:]) where T.Property == U {
